...
mod tests {
    ...
    fn system_role_deny_matrix_for_sensitive_actions() {
        ...
        let deny_pairs: &[(&str, Role)] = &[
            ...
            // Phase 4.3 — Member cannot manage policy or flip kill switch
            ("ai.agent.run", Role::ReadOnly),
            ("ai.agent.manage", Role::Member),
            ("ai.agent.manage", Role::ReadOnly),
            ("ai.agent.manage", Role::Sales),
            ("ai.agent.manage", Role::Finance),
            ("ai.agent.manage", Role::Manager),
            ("ai.agent.kill", Role::Member),
            ("ai.agent.kill", Role::ReadOnly),
