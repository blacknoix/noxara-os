...
DROP POLICY IF EXISTS operations_project_tenant_isolation ON operations_project;
...
DROP POLICY IF EXISTS operations_task_tenant_isolation ON operations_task;
...
DROP POLICY IF EXISTS operations_task_checklist_tenant_isolation ON operations_task_checklist;
...
DROP POLICY IF EXISTS operations_task_comment_tenant_isolation ON operations_task_comment;
...
DROP POLICY IF EXISTS operations_notification_intent_tenant_isolation ON operations_notification_intent;
...
DROP POLICY IF EXISTS operations_task_attachment_tenant_isolation ON operations_task_attachment;
...
DROP POLICY IF EXISTS operations_task_dependency_tenant_isolation ON operations_task_dependency;
...
DROP POLICY IF EXISTS operations_idempotency_tenant_isolation ON operations_idempotency;
