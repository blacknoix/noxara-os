...
DROP POLICY IF EXISTS people_employee_tenant_isolation ON people_employee;
...
DROP POLICY IF EXISTS people_contract_tenant_isolation ON people_employment_contract;
...
DROP POLICY IF EXISTS people_comp_tenant_isolation ON people_compensation_component;
...
DROP POLICY IF EXISTS people_document_tenant_isolation ON people_document;
...
DROP POLICY IF EXISTS people_asset_tenant_isolation ON people_asset;
...
DROP POLICY IF EXISTS people_task_tenant_isolation ON people_task;
...
DROP POLICY IF EXISTS people_timeline_tenant_isolation ON people_timeline_event;
...
DROP POLICY IF EXISTS people_workflow_tenant_isolation ON people_workflow_run;
...
DROP POLICY IF EXISTS people_idempotency_tenant_isolation ON people_idempotency;
