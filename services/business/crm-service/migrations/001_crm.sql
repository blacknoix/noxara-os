...
DROP POLICY IF EXISTS sales_pipeline_tenant_isolation ON sales_pipeline;
...
DROP POLICY IF EXISTS sales_pipeline_stage_tenant_isolation ON sales_pipeline_stage;
...
DROP POLICY IF EXISTS sales_customer_tenant_isolation ON sales_customer;
...
DROP POLICY IF EXISTS sales_contact_tenant_isolation ON sales_contact;
...
DROP POLICY IF EXISTS sales_lead_tenant_isolation ON sales_lead;
...
DROP POLICY IF EXISTS sales_deal_tenant_isolation ON sales_deal;
...
DROP POLICY IF EXISTS sales_deal_stage_history_tenant_isolation ON sales_deal_stage_history;
...
DROP POLICY IF EXISTS sales_quote_tenant_isolation ON sales_quote;
...
DROP POLICY IF EXISTS sales_quote_line_tenant_isolation ON sales_quote_line;
...
DROP POLICY IF EXISTS sales_activity_tenant_isolation ON sales_activity;
...
DROP POLICY IF EXISTS sales_idempotency_tenant_isolation ON sales_idempotency;
...
DROP POLICY IF EXISTS sales_import_job_tenant_isolation ON sales_import_job;
