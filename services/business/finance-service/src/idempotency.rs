//! `Idempotency-Key` support for finance POSTs (issue/pay/credit).
    ...
    E: sqlx::PgExecutor<'e>,
{
    sqlx::query(
        r#"
        INSERT INTO finance_idempotency (id, org_id, scope, key, response_status, response_body)
        VALUES ($1,$2,$3,$4,$5,$6)
