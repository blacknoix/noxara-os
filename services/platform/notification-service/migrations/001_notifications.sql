...
DROP POLICY IF EXISTS notification_item_tenant_isolation ON notification_item;
...
DROP POLICY IF EXISTS notification_delivery_tenant_isolation ON notification_delivery;
...
DROP POLICY IF EXISTS notification_processed_tenant_isolation ON notification_processed;
...
DROP POLICY IF EXISTS notification_processed_ingest ON notification_processed;
...
DROP POLICY IF EXISTS notification_item_ingest ON notification_item;
CREATE POLICY notification_item_ingest ON notification_item
    USING (current_setting('app.notification_ingest', true) = '1')
    WITH CHECK (current_setting('app.notification_ingest', true) = '1');

DROP POLICY IF EXISTS notification_delivery_ingest ON notification_delivery;
CREATE POLICY notification_delivery_ingest ON notification_delivery
    USING (current_setting('app.notification_ingest', true) = '1')
    WITH CHECK (current_setting('app.notification_ingest', true) = '1');

DROP POLICY IF EXISTS notification_preference_ingest ON notification_preference;
